...
![img](./images/app-list.png)

## 掘金自动签到
![img](./images/app-detail1.png)

## 开启定时任务，爬取新浪热搜，自动执行
![img](./images/app-detail2.png)

## 截取新浪热搜每一条的元素
![img](./images/app-detail3.png)

## JSON数据格式，每一步配置均可配置
![img](./images/app-setting.png)

## 非常方便的嵌入式工具箱，满足你的大部分需求
![img](./images/app-plugin-setting1.png)

## 选取元素高亮显示，简单易懂
![img](./images/app-plugin-setting2.png)
